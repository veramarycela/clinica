...
class Facturas(models.Model):
    ...
    @api.depends('x_clinica_paciente_id')
    def _compute_x_direccion_ci_paciente(self):
        for record in self:
            if record.x_clinica_paciente_id:
                direccion = record.x_clinica_paciente_id.direccion
                identificacion = record.x_clinica_paciente_id.identification
                record.x_direccion_ci_paciente = f"{direccion} {identificacion}"
            else:
                record.x_direccion_ci_paciente = ''
